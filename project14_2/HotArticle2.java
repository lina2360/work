...
public class HotArticle2 extends AppCompatActivity {//買賣資料庫差和單詞差和返回差
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tv681=(TextView)findViewById(R.id.tv68_1);
        TextView tv682=(TextView)findViewById(R.id.tv68_2);
...
//        setSupportActionBar(toolbar);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent1.setClass(HotArticle2.this, Forum.class);
        ...
        DatabaseReference[] reference_contacts11 = {FirebaseDatabase.getInstance().getReference("articletitle")};//買家推薦
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(has==true){
                    ...
                    if(have2==true) {
                        ...
                        if(items.size()!=0){
                            searchAdapter=new SearchAdapter(HotArticle2.this,items,"null");
                            ...
                            lv681.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
                                    ...
                                    intent7.setClass(HotArticle2.this, ArticlePage.class);
                                    Bundle bundle = new Bundle();
                                    bundle.putInt("who",0);
                                    bundle.putInt("num",1);
        ...
        DatabaseReference[] reference_contacts12 = {FirebaseDatabase.getInstance().getReference("seller_article")};
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            Intent intent1 = new Intent();
            intent1.setClass(HotArticle2.this, Seller.class);
            startActivity(intent1);
            finish();
        }
        return false;
