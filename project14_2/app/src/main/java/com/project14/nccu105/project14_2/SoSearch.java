...
public class SoSearch extends AppCompatActivity {//買賣資料庫差和單詞差和返回差
    ListView lv62;
...
//        setSupportActionBar(toolbar);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent1.setClass(SoSearch.this, Seller.class);
        ...
        reference_contacts[0].addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(have==true) {
                    ...
                    if(items.size()!=0){
                        SearchAdapter searchAdapter=new SearchAdapter(SoSearch.this,items,"seller_order");
                        ...
                        lv62.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                                ...
                                intent7.setClass(SoSearch.this, SellerOrder.class);
